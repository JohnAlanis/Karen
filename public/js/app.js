...
IndexHeight = document.getElementById('Section1').clientHeight;
document.getElementById('Section1').setAttribute("style","height:" + (IndexHeight + 55) + "px");

QuienesSomosHeight = document.getElementById('Section2').clientHeight;
...
function showMenu(){
	...
	buttonHideMenu.setAttribute("style","background: #e81e48")
}
...
bodys.on("panright", showMenu)
bodys.on("panleft", hideMenu)

//REQUIRIENDO JQUERY PARA MOVERNOS A TRAVES DE LA PAGINA
